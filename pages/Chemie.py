...
# Dictionary containing atomic masses of elements in the periodic table
atomic_masses = {
...
def calculate_amount_of_substance(mass, molar_mass):
...
if __name__ == "__main__":
    ...
    amount_of_substance = calculate_amount_of_substance(mass, molar_mass)
    
    print(f"Molar mass of {formula}: {molar_mass} g/mol")
    print(f"Amount of substance: {amount_of_substance} mol")