...
element = st.selectbox("Wähle ein Element:", list(elemente.keys()))

# Anzeige der molaren Masse des ausgewählten Elements
molare_masse = elemente[element]
st.write(f"Molare Masse von {element}: {molare_masse} g/mol")
...
if st.button("Berechne Stoffmenge"):
    if molare_masse > 0:
        ...
        st.write("Die molare Masse muss größer als 0 sein.")